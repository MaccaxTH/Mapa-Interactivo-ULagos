...
el aspecto del mapa interactivo, pero son necesarios de mantener para que Ren'py pueda funcionar y no crashee.
'''
init offset = -2
init python:
    gui.init(1920, 1080)
...
## Configuraciones de renpy para que funcione en celulares
